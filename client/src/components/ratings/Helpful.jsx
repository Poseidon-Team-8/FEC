...
const Helpful = ({ yesCount, reviewId }) => {
  ...
  return (
    <div>
      ...
      <a style={{"cursor": "pointer"}} className='helpful-count' onClick={ (e) => updateYesCounter(e) }>Yes</a>
      <span> ({ yesCounter }) | </span>
      <a style={{"cursor": "pointer"}} className='helpful-count' onClick={ (e) => updateNoCounter(e) }>No</a>
      <span> ({ noCounter })</span>
    </div>
  );
}
